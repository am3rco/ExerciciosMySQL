...
VALUES('Base Líquida', 39.90, 'Cobertura natural para pele', 50, 1);
INSERT INTO tb_produtos(produto, preço, descrição, estoque, categoria_id)
VALUES('Batom Matte', 19.90, 'Acabamento opaco e duradouro', 30, 1);
INSERT INTO tb_produtos(produto, preço, descrição, estoque, categoria_id)
...
INSERT INTO tb_produtos(produto, preço, descrição, estoque, categoria_id)
VALUES('Shampoo Anticaspa Premium', 75.90, 'Tratamento contra caspa e seborreia', 70, 1);
INSERT INTO tb_produtos(produto, preço, descrição, estoque, categoria_id)
